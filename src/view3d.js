...
function hover3d() {
  ...
  /* app.js 注入的 DOM 提示条（view3d 内不得直接触碰 DOM） */
  function showTooltip(px, py, text) { if (tooltips.show) tooltips.show(px, py, text); }
  function hideTooltip() { if (tooltips.hide) tooltips.hide(); }
